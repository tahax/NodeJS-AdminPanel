document.getElementById("imageUpload").onclick = function () {
  ...
  xhttp.onreadystatechange = function () {
    ...
    if (xhttp.status == 201) {
      document.getElementById("uploadedimagetag").src = this.responseText;
      document.querySelector(".img-profile").src = this.responseText;
      imageStatus.innerHTML = "عکس حساب کاربری شما با موفقیت تغییر کرد";
      selectedImage.value = "";
    } else {
  ...
  xhttp.open("POST", "/profile-image-upload");
